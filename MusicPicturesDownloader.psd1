@{
    ...
    FunctionsToExport = @('Invoke-QCheckArtistQueryMap','Invoke-QCheckArtist','Save-QArtistsImages','Save-QAlbumCover','Save-QTrackCover','Update-GenresForDirectory','Update-TrackGenresFromLastFm')
}
